...
export const socket = io("https://rive-capybara-backend-production.up.railway.app");
export const ioSocket = socket.connect("https://rive-capybara-backend-production.up.railway.app");
